...
/// @param enforceCallRestrictions Whether `allowedCalls` is enforced (`true`) or the key is unrestricted (`false`)
/// @param allowedCalls Per-target call scopes for this key when call restrictions are enforced.
